            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: pokemon.type
                    .map((e) => FilterChip(backgroundColor: Colors.amber, label: Text(e),onSelected: (b) {},)).toList(),
              ),
              Text("weakness"),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: pokemon.weaknesses
                    .map((e) => FilterChip(backgroundColor: Colors.red,
                  label: Text(
                      e,
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: pokemon.weaknesses
                    .map((e) => FilterChip(backgroundColor: Colors.green,
                  label: Text(
                    e,
                    style: TextStyle(color: Colors.white),
                  ),onSelected: (b) {},)).toList(),
